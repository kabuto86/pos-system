...
- `docs/migrasi-mysql/PELAN.md` — keputusan reka bentuk & skema 34 jadual (rujukan tetap)
...
PELAN.md bahagian 3. `outlet_id` pula skop perniagaan — boleh dari input,
tetapi mesti disahkan milik vendor semasa.
